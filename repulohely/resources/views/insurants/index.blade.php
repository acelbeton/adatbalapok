            ...
            @foreach($insurances as $insurance)
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('insurants.destroy', $insurance->name) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this insurance company?')">Delete</button>
                        </form>
                    </td>
                </tr>
            @endforeach
